...
function Tag() {
    ...
    return (
        <div className = {"rounded-md  h-[300px] lg:w-[800px] w-[600px] bg-gray-200 p-1 mt-1 shadow-2xl"}>
            <div className = {"rounded-md flex justify-center items-center p-1 mb-1 w-full"}>
                <h1 className = {"rounded-md border font-bold text-black text-center p-[2px]"}>Random {tag} GIF</h1>
            </div>
            <div className = {"rounded-md p-1 mb-1 flex flex-col justify-center items-center h-max"}>
                <div className = {"rounded-md border h-[210px] mb-2 w-full flex justify-center items-center overflow-hidden"}>
                    {
                ...
                <div className = {"flex flex-row justify-center items-center rounded-md w-full "}>
                    <input className = {"border lg:w-[400px] md:w-[300px] text-center overflow-auto outline-blue-400 cursor-pointer mr-2"}
                           type = "text"
                           placeholder = {"search meme here"}
                           value = {tag}
